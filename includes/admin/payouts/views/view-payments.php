...
<div class="wrap slicewp-wrap slicewp-wrap-payments">
	...
	<form method="GET">
		...
		<a href="<?php echo esc_url( $this->admin_url ); ?>" class="page-title-action"><?php echo '&#x2190; ' . __( 'Back to Payouts', 'slicewp' ); ?></a>
		...
		<input type="hidden" name="subpage" value="view-payments" />
